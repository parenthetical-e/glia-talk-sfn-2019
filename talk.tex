...
\begin{figure}
    ...
    \caption{
    \begin{itemize}
        \item $\alert{w^o_{1,1} = \sum w_{i,j}^o}$
...
\caption{I tested three fundamental astrocyte wave types [in PyTorch].}
\end{figure}
\end{frame}
...
\begin{itemize}
\item Artifical upper bound $\rightarrow$ biological upper bound (\alert{help})
