...
\begin{itemize}
    ...
    \item \alert{Distributed $Ca^{2+}$ dynamics can do computations?}
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Past work.}
\begin{figure}
    \centering
    \includegraphics[scale=0.45]{images/agn.png} 
    \caption{All theoretical accounts focus on local neuron-glia interactions.}
\end{figure}
\end{frame}
